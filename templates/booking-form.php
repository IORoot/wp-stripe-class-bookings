...
$labels = apply_filters(
	...
	[
		...
		'external_button'       => __( 'Continue to booking', 'ioroot-yoga-bookings' ),
		'external_hint'         => __( 'This class uses an external booking page.', 'ioroot-yoga-bookings' ),
		'invalid_external_hint' => __( 'External booking is enabled, but no URL has been set for this class yet.', 'ioroot-yoga-bookings' ),
		'inactive_hint'         => __( 'Booking is currently unavailable for this class.', 'ioroot-yoga-bookings' ),
		'no_dates_hint'         => __( 'No upcoming dates available — please check back soon or contact us.', 'ioroot-yoga-bookings' ),
		'redirect_hint'         => __( 'You will be redirected to Stripe to complete your payment securely.', 'ioroot-yoga-bookings' ),
		'waiver_label'          => (string) \IORoot_Yoga_Bookings\Helpers::get_option( 'waiver_label', __( 'I confirm I have read and accept the class waiver and participate at my own risk.', 'ioroot-yoga-bookings' ) ),
		'waiver_page_link_text' => __( 'View full waiver', 'ioroot-yoga-bookings' ),
		'mailchimp_optin_label' => (string) \IORoot_Yoga_Bookings\Helpers::get_option( 'mailchimp_optin_label', __( 'Yes, I would like to join the mailing list for class updates and news.', 'ioroot-yoga-bookings' ) ),
	],
	$class_data,
	$dates
);
			...
			<header class="yb-form__hero">
				...
				<?php if ( $show_price_badge ) : ?>
					<div class="yb-form__price-badge">
						<span class="yb-form__price-badge-label"><?php esc_html_e( 'From', 'ioroot-yoga-bookings' ); ?></span>
				...
				<div class="yb-form__row yb-form__row--check yb-form__row--waiver">
					<div class="yb-form__waiver" data-yb-waiver-group>
						<input
							...
							value="1"
							required
							aria-label="<?php echo esc_attr__( 'Accept the waiver', 'ioroot-yoga-bookings' ); ?>"
