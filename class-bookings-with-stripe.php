...
require_once CLASBOWI_DIR . 'includes/views/class-template-loader.php';
require_once CLASBOWI_DIR . 'includes/views/class-abstract-view.php';
require_once CLASBOWI_DIR . 'includes/views/class-booking-form-view.php';
require_once CLASBOWI_DIR . 'includes/views/class-booking-status-view.php';
